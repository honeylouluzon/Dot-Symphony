class DotSymphony {
    constructor() {
        ...
        this.sentimentMap = {
            ...
            happy: { color: '#FFD700', shape: 'circle', emotion: 'joy', instruments: ['piano', 'guitar'] },
            ...
            peaceful: { color: '#4ECDC4', shape: 'circle', emotion: 'calm', instruments: ['flute', 'strings'] },
            anxious: { color: '#FFA500', shape: 'square', emotion: 'anxiety', instruments: ['synth', 'bass'] },
            worried: { color: '#FFA500', shape: 'square', emotion: 'anxiety', instruments: ['synth', 'bass'] },
